-- HexaCards — country seed
-- Layout matches screenshot: country_id 1 = India, then Albania, Algeria, ...
-- Safe to re-run (upsert on country_id)
...
values
  ...
  (29, 'BV', 'BOUVET ISLAND', 'Bouvet Island', 'BVT', 74, 0, 1),
  (30, 'BR', 'BRAZIL', 'Brazil', 'BRA', 76, 55, 1),
  (31, 'IO', 'BRITISH INDIAN OCEAN TERRITORY', 'British Indian Ocean Territory', 'IOT', 86, 246, 1),
  ...
  (45, 'CX', 'CHRISTMAS ISLAND', 'Christmas Island', 'CXR', 162, 61, 1),
  ...
  (50, 'CD', 'CONGO, THE DEMOCRATIC REPUBLIC OF THE', 'Congo, the Democratic Republic of the', 'COD', 180, 243, 1),
  ...
  (76, 'TF', 'FRENCH SOUTHERN TERRITORIES', 'French Southern Territories', 'ATF', 260, 0, 1),
  ...
  (93, 'HM', 'HEARD ISLAND AND MCDONALD ISLANDS', 'Heard Island and Mcdonald Islands', 'HMD', 334, 0, 1),
  ...
  (126, 'MK', 'NORTH MACEDONIA', 'North Macedonia', 'MKD', 807, 389, 1),
  ...
  (137, 'YT', 'MAYOTTE', 'Mayotte', 'MYT', 175, 269, 1),
  ...
  (176, 'RO', 'ROMANIA', 'Romania', 'ROU', 642, 40, 1),
  (177, 'RU', 'RUSSIAN FEDERATION', 'Russian Federation', 'RUS', 643, 7, 1),
  ...
  (189, 'RS', 'SERBIA', 'Serbia', 'SRB', 688, 381, 1),
  ...
  (198, 'GS', 'SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS', 'South Georgia and the South Sandwich Islands', 'SGS', 239, 0, 1),
  ...
  (212, 'TL', 'TIMOR-LESTE', 'Timor-Leste', 'TLS', 626, 670, 1),
  ...
  (218, 'TR', 'TÜRKIYE', 'Türkiye, The Republic of', 'TUR', 792, 90, 1),
  (219, 'TM', 'TURKMENISTAN', 'Turkmenistan', 'TKM', 795, 993, 1),
  ...
  (227, 'UM', 'UNITED STATES MINOR OUTLYING ISLANDS', 'United States Minor Outlying Islands', 'UMI', 581, 1, 1),
  ...
  (240, 'ME', 'MONTENEGRO', 'Montenegro', 'MNE', 499, 382, 1),
  (241, 'XK', 'KOSOVO', 'Kosovo', 'XKX', 0, 383, 1),
  (242, 'AF', 'AFGHANISTAN', 'Afghanistan', 'AFG', 4, 93, 1)
on conflict (country_id) do update set
  iso = excluded.iso,
  country_name = excluded.country_name,
  nicename = excluded.nicename,
  iso3 = excluded.iso3,
...
select setval(
  pg_get_serial_sequence('public.country', 'country_id'),
  (select coalesce(max(country_id), 1) from public.country)
);
