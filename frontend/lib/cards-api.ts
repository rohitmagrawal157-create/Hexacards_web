...
export function profileToCardBody(
  ...
  return {
    ...
    website: profile.contact.website.trim() || null,
    ...
    facebookUrl: profile.social.facebook.trim() || null,
    instagramUrl: profile.social.instagram.trim() || null,
    linkedinUrl: profile.social.linkedin.trim() || null,
